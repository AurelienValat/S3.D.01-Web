    ...
    try {
        ...
        if (empty($erreursModif)) {
            if ($estEnCoursDeVisite && !$confirmation) {
                ...
                echo "<div style='margin: 20px auto; padding: 20px; max-width: 500px; border: 1px solid #ccc; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); font-family: Arial, sans-serif;'>
...
<script>
    ...
    function remplirFormulaire(idExposition, description) {
        // Remplir les champs du formulaire
        document.getElementById('idExposition').value = idExposition;
